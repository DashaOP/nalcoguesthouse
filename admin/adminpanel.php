...
<nav class="navbar navbar-expand-lg navbar-light bg-dark" style="padding-left:40px;padding-right:40px;">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="studentrelated.php" name="sort" value="related" style="color:white">Student Related</a>
      </li>
      <li class="nav-item active">
...
$query="SELECT * FROM admindata order by booking_date desc";
...
while($row=mysqli_fetch_array($result)){
  ...
  echo '<td style="width:150;"><div class="no"><a href="../approve.php?name='.$row['name'].'&amp;email='.$row['email'].'&amp;phone='.$row['phone'].
  '&amp;group='.$row['type'].'&amp;booking_date='.$row['booking_date'].'">Approve</a></div></td></tr>';
}
